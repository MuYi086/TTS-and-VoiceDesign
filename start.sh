...
VOXCPM2_HELPER_DEFAULT="$HOME/github/timbre-design/modelScript/tts_local_voxcpm2.py"
VOXCPM2_HELPER_LEGACY="$HOME/github/timbre-design/scripts/tts_local_voxcpm2.py"
if [[ -z "${VOXCPM2_HELPER_SCRIPT:-}" || "$VOXCPM2_HELPER_SCRIPT" == "$VOXCPM2_HELPER_LEGACY" ]]; then
