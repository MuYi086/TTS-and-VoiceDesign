...
VOXCPM2_HELPER_DEFAULT="$API_DIR/voxcpm2_helpers.py"
VOXCPM2_HELPER_EXTERNAL_DEFAULT="$HOME/github/timbre-design/modelScript/tts_local_voxcpm2.py"
VOXCPM2_HELPER_EXTERNAL_LEGACY="$HOME/github/timbre-design/scripts/tts_local_voxcpm2.py"
if [[ -z "${VOXCPM2_HELPER_SCRIPT:-}" ]]; then
  export VOXCPM2_HELPER_SCRIPT="$VOXCPM2_HELPER_DEFAULT"
elif [[ ! -f "$VOXCPM2_HELPER_SCRIPT" ]] && \
  [[ "$VOXCPM2_HELPER_SCRIPT" == "$VOXCPM2_HELPER_EXTERNAL_DEFAULT" || \
    "$VOXCPM2_HELPER_SCRIPT" == "$VOXCPM2_HELPER_EXTERNAL_LEGACY" ]]; then
  export VOXCPM2_HELPER_SCRIPT="$VOXCPM2_HELPER_DEFAULT"
fi
...
export VOXCPM2_OUTPUT_DIR="${VOXCPM2_OUTPUT_DIR:-$API_DIR/tempAudio}"
...
echo "VoxCPM2 output:      $VOXCPM2_OUTPUT_DIR"
