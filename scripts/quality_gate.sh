...
for project in qwen3_tts mimo_tts voxcpm2 LongCat_AudioDiT_3.5B_bf16 \
    ...
    qwen3_voiceDesign moss_voiceGenerator moss_audio_4b_thinking Confucius4_TTS Qwen3_ASR_1.7B Step_Audio_EditX firered_tts3 TIGER-DnR qa; do
...
uv run --project qa --locked ruff check \
    ...
    dots_tts_soar moss_soundEffect stable_audio_3_medium ace_step_1_5 \
    qwen3_voiceDesign moss_voiceGenerator moss_audio_4b_thinking Confucius4_TTS Qwen3_ASR_1.7B Step_Audio_EditX firered_tts3 TIGER-DnR tests
